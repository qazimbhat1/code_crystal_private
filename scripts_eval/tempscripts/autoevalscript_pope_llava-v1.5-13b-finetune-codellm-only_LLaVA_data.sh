#!/bin/bash 
#SBATCH --job-name=a_popellava-v1.5-13b-finetune-codellm-only_LLaVA_data
#SBATCH --output=eval_pope_llava-v1.5-13b-finetune-codellm-only_LLaVA_data.txt
#SBATCH --nodes=1
#SBATCH --mem=490G
...
python -m llava.eval.model_vqa_loader \
    ...
    --answers-file /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/fork_LLaVA/playground/data/eval/pope/answers/llava-v1.5-13b-finetune-codellm-only_LLaVA_data05.09-11.06.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1
...
python llava/eval/eval_pope.py \
    ...
    --question-file /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/fork_LLaVA/playground/data/eval/pope/llava_pope_test.jsonl \
    --result-file /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/fork_LLaVA/playground/data/eval/pope/answers/llava-v1.5-13b-finetune-codellm-only_LLaVA_data05.09-11.06.jsonl
