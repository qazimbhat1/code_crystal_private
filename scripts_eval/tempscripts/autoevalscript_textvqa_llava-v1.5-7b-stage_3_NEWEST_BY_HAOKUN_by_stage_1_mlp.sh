#!/bin/bash 
#SBATCH --job-name=a_textvqallava-v1.5-7b-stage_3_NEWEST_BY_HAOKUN_by_stage_1_mlp
#SBATCH --output=eval_textvqa_llava-v1.5-7b-stage_3_NEWEST_BY_HAOKUN_by_stage_1_mlp.txt
#SBATCH --nodes=1
#SBATCH --mem=490G
...
python -m llava.eval.model_vqa_loader \
    ...
    --answers-file /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/fork_LLaVA/playground/data/eval/textvqa/answers/llava-v1.5-7b-stage_3_NEWEST_BY_HAOKUN_by_stage_1_mlp03.27-17.46.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1 
...
python -m llava.eval.eval_textvqa \
    ...
    --result-file /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/fork_LLaVA/playground/data/eval/textvqa/answers/llava-v1.5-7b-stage_3_NEWEST_BY_HAOKUN_by_stage_1_mlp03.27-17.46.jsonl