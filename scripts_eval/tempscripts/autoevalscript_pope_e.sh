#!/bin/bash 
#SBATCH --job-name=a_popee
#SBATCH --output=eval_pope_e.txt
#SBATCH --nodes=1
#SBATCH --mem=490G
...
python -m llava.eval.model_vqa_loader \
    ...
    --answers-file /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/fork_LLaVA/playground/data/eval/pope/answers/e05.08-15.25.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1
...
python llava/eval/eval_pope.py \
    ...
    --question-file /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/fork_LLaVA/playground/data/eval/pope/llava_pope_test.jsonl \
    --result-file /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/fork_LLaVA/playground/data/eval/pope/answers/e05.08-15.25.jsonl
