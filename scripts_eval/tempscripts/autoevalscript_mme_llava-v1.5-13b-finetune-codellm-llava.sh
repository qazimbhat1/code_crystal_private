#!/bin/bash 
#SBATCH --job-name=a_mmellava-v1.5-13b-finetune-codellm-llava
#SBATCH --output=eval_mme_llava-v1.5-13b-finetune-codellm-llava.txt
#SBATCH --nodes=1
#SBATCH --mem=490G
...
python -m llava.eval.model_vqa_loader \
    ...
    --answers-file /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/fork_LLaVA/playground/data/eval/MME/answers/llava-v1.5-13b-finetune-codellm-llava05.08-14.01.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1

cd /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/fork_LLaVA/playground/data/eval/MME 

python convert_answer_to_mme.py --experiment llava-v1.5-13b-finetune-codellm-llava05.08-14.01

cd eval_tool 

python calculation.py --results_dir answers/llava-v1.5-13b-finetune-codellm-llava05.08-14.01