#!/bin/bash 
#SBATCH --job-name=a_mmellava-v1.5-7b-LLaVA_finetuning_using_xformer_llama2_from_pretrain_llama2_xformer_llava_data
#SBATCH --output=eval_mme_llava-v1.5-7b-LLaVA_finetuning_using_xformer_llama2_from_pretrain_llama2_xformer_llava_data.txt
#SBATCH --nodes=1
#SBATCH --mem=490G
