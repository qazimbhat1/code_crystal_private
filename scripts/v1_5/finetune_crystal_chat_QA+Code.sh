...
#SBATCH --output=finetune_crystal_chat_tokenizer_correct_Code_+_150k_QA.txt
#SBATCH --nodes=4
#SBATCH --nodelist=gpumid-21,gpumid-22,gpumid-23,gpumid-27
#SBATCH --mem=200G
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile.txt llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/new_unified_web_style/llava_final_v1_5_Unified_web_style_Junbo10k_pix2code_Junbo50k_QA_150k.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-finetune-crystal_chat-tokenizer-correct-Code+150k_QA \
    --num_train_epochs 1 \
