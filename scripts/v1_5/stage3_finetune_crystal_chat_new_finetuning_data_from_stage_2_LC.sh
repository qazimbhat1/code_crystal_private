...
#SBATCH --output=STAGE-3_new_finetune_data_shuffled_Stage_2_LC_shuffled____finetune_Pretrained_with_short_caption______+_______crystal_chat_tokenizer_correct_Websight_websrc_code_QA_llava.txt
#SBATCH --nodes=4
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile_new.txt llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path /lustre/scratch/shared-folders/vision-project/Backup/llava_data/visionteam_instunedata_rdshuffled_0221.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-STAGE-3_new_finetune_data_shuffled_Stage_2_LC_shuffled_________finetune-Pretrained-with-short-caption__________+_______crystal_chat-tokenizer-correct_Websight_websrc_code_QA_llava \
    --num_train_epochs 1 \
