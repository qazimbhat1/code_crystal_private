#!/bin/bash
#SBATCH --job-name=stage1_and_2_A1_with_text_llava_arch_NEWEST # Job name
#SBATCH --output=stage1_and_2_A1_with_text_llava_arch_NEWEST.txt
#SBATCH --nodes=4
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile.txt llava/train/train_mem.py \
    ...
    --version plain \
    --data_path /lustre/scratch/shared-folders/vision-project/Backup/data/text_add2/stage12_w_text.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-stage1_and_2_with_text_A1_llava_arch_NEWEST \
    --num_train_epochs 1 \
