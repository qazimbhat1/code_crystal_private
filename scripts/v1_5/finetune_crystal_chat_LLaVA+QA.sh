...
#SBATCH --output=finetune_crystal_chat_tokenizer_correct_llava_+_150k_QA.txt
#SBATCH --nodes=4
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile_new.txt llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-finetune-crystal_chat-tokenizer-correct-LLaVA+150k_QA \
    --num_train_epochs 1 \
