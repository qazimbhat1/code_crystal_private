...
#SBATCH --output=finetune_crystal_chat_only_llava.txt
#SBATCH --nodes=2
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile_new.txt llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path /lustre/scratch/shared-folders/vision-project/Backup/data/text_add2/original_instruction_tunning.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-finetune-crystal_chat-only_LLaVA_data \
    --num_train_epochs 1 \
