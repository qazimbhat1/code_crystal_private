#!/bin/bash
#SBATCH --job-name=stage3_with_new_text_mlp_from_stage_1_mlp # Job name
#SBATCH --output=stage3_with_new_text_mlp_from_stage_1_mlp.txt
#SBATCH --nodes=4
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile_new.txt llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/stage3_with_new_text_mlp_from_stage_1_mlp \
    --num_train_epochs 1 \
