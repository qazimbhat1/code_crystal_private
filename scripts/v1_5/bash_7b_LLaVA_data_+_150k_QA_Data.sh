...
#SBATCH --output=7b-v1.5-7b-LLaVA-data-+-150k-QA-data.txt
#SBATCH --nodes=4
#SBATCH --nodelist=gpumid-20,gpumid-21,gpumid-22,gpumid-23
#SBATCH --mem=200G
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile_new.txt llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-LLaVA-data_+_150k_QA_data \
    --num_train_epochs 1 \
