#!/bin/bash
#SBATCH --job-name=stage3_without_text_mlp_from_stage_1_mlp # Job name
#SBATCH --output=stage3_without_text_mlp_from_stage_1_mlp.txt
#SBATCH --nodes=2
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile_3.txt llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path /lustre/scratch/shared-folders/vision-project/Backup/data/text/stage3.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/stage3_without_text_mlp_from_stage_1_mlp \
    --num_train_epochs 1 \
