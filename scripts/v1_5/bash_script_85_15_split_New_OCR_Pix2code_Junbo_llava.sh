...
#SBATCH --output=85_15_split_OCR_Junbo_new_instruction_pix2code_corrected_llava.txt
#SBATCH --nodes=4
#SBATCH --nodelist=gpumid-26,gpumid-27,gpumid-28,gpumid-29
#SBATCH --mem=200G
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile.txt llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-13b-85_15_split_OCR_junbo_new-complex_+_Pix2code_correct_+_llava---final \
    --num_train_epochs 1 \
