#!/bin/bash
#SBATCH --job-name=stage3_using_ours_crystal_chat_using_pretrain_ours_LLaVA_data # Job name
#SBATCH --output=stage3_using_ours_crystal_chat_using_pretrain_ours_LLaVA_data.txt
#SBATCH --nodes=4
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile_new.txt llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-stage3_using_ours_crystal_chat_using_pretrain_LLaVA_data \
    --num_train_epochs 1 \
