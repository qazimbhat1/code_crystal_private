...
#SBATCH --output=llava_data_+_rusiru_150k.txt
#SBATCH --nodes=4
#SBATCH --nodelist=gpumid-08,gpumid-09,gpumid-10,gpumid-11
#SBATCH --mem=200G
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile.txt llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_final_v1_5_llava_data_+_rusiru_data.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-13b-llava_data_+_QA_150k \
    --num_train_epochs 1 \
