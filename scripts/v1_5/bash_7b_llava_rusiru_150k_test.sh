...
#SBATCH --output=7b_llava_rusiru_150_test.txt
#SBATCH --nodes=4
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile.txt llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_final_v1_5_Rusiru_150k_test.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-rusiru_150k_replaced_660k_total \
    --num_train_epochs 1 \
