...
#SBATCH --output=pretrain_Non_shuffled_Short_caption_crystal_chat_llava.txt
#SBATCH --nodes=4
#SBATCH --nodelist=gpumid-06,gpumid-21,gpumid-22,gpumid-27
#SBATCH --mem=200G
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile.txt llava/train/train_mem.py \
    ...
    --version plain \
    --data_path /lustre/scratch/shared-folders/vision-project/Backup/llava_data/visionteam_scdata_0208.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-crystal_chat-Non_shuffled_short-caption \
    --num_train_epochs 1 \
