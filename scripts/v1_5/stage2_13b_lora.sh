...
#SBATCH --output=STAGE_2__LORA_Long_Caption_no_mimic_shuffled_stage_1_shuffled_short_caption.txt
#SBATCH --nodes=2
#SBATCH --nodelist=gpumid-05,gpumid-26
#SBATCH --mem=490G
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile.txt llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/fork_LLaVA/checkpoints/llava-v1.5-13b-lora-STAGE_2_LORA_Long_Caption_no_mimic_shuffled_stage_1_shuffled_short_caption-lora \
    --num_train_epochs 1 \
