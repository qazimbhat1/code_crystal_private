...
#SBATCH --output=finetune_codellm_only_LLaVA_data.txt
#SBATCH --nodes=4
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile.txt llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_v1_5_mix665k.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-13b-finetune-codellm-only_LLaVA_data\
    --num_train_epochs 1 \
