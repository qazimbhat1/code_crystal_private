...
#SBATCH --output=finetune_Pretrained_with_short_caption______+_______crystal_chat_tokenizer_correct_Websight_websrc_code_QA_llava___CONFIRM__MME.txt
#SBATCH --nodes=2
#SBATCH --nodelist=gpumid-03,gpumid-04
#SBATCH --mem=200G
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile_3.txt llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-finetune-Pretrained-with-short-caption__________+_______crystal_chat-tokenizer-correct_Websight_websrc_code_QA_llava____CONFIRM__MME \
    --num_train_epochs 1 \
