#!/bin/bash
#SBATCH --job-name=stage3_with_text_mlp_from_stage_2_with_text_mlp_from_stage_1_mlp_crystal_chat # Job name
#SBATCH --output=stage3_with_text_mlp_from_stage_2_with_text_mlp_from_stage_1_mlp_crystal_chat.txt
#SBATCH --nodes=4
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile.txt llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/stage3_with_text_mlp_from_stage_2_with_text_mlp_from_stage_1_mlp_crystal_chat \
    --num_train_epochs 2 \
