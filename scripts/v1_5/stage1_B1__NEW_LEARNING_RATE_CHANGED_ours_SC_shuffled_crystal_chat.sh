#!/bin/bash
#SBATCH --job-name=stage1_B1__NEW_LEARNING_RATE_CHANGED_ours_SC_shuffled_crystal_chat # Job name
#SBATCH --output=stage1_B1__NEW_LEARNING_RATE_CHANGED_ours_SC_shuffled_crystal_chat.txt
#SBATCH --nodes=4
#SBATCH --nodelist=gpumid-07,gpumid-22,gpumid-23,gpumid-24
#SBATCH --mem=200G
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile_new.txt llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-stage1_B1__NEW_LEARNING_RATE_CHANGED_ours_SC_shuffled_crystal_chat \
    --num_train_epochs 1 \
