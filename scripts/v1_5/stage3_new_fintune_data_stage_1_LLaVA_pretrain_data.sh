...
#SBATCH --output=stage3_C2_new_data_shuffled_+_Stage1_LLaVA_pretrain_data______+_______crystal_chat__NEW.txt
#SBATCH --nodes=4
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile.txt llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/stage3_new_data_shuffled_+_Stage1_LLaVA_pretrain_data______+_______crystal_chat \
    --num_train_epochs 1 \
