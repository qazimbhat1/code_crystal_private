...
#SBATCH --output=stage3_C1_2_epoch_new_data_old_projector_from_stage2_from_stage1_crystal_chat.txt
#SBATCH --nodes=4
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile_new.txt llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-stage3_C1_2_epochs_new_data_old_projector_from_stage2_from_stage1_crystal_chat \
    --num_train_epochs 2 \
