#!/bin/bash
#SBATCH --job-name=LLaVA_finetuning_using_xformer_llama2_from_pretrain_llama2_xformer_llava_data # Job name
#SBATCH --output=LLaVA_finetuning_using_xformer_llama2_from_pretrain_llama2_xformer_llava_data_new_tokenizer.txt
#SBATCH --nodes=2
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile_3.txt llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/fork_LLaVA/checkpoints/llava-v1.5-7b-pretrain_llama_2_xformer_crystal_chat_new_tokenizer/mm_projector.bin \
    --mm_projector_type xformer \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-LLaVA_finetuning_using_xformer_llama2_from_pretrain_llama2_xformer_llava_data_new_tokenizer \
    --num_train_epochs 1 \
