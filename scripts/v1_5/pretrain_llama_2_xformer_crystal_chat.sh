#!/bin/bash
#SBATCH --job-name=pretrain_llama_2_xformer_crystal_chat # Job name
#SBATCH --output=pretrain_llama_2_xformer_crystal_chat_new_tokenizer.txt
#SBATCH --nodes=2
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile_3.txt llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-pretrain_llama_2_xformer_crystal_chat_new_tokenizer \
    --num_train_epochs 1 \
