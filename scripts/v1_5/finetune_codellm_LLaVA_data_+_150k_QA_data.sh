...
#SBATCH --output=codellm_LLaVA_DATA_+_150K_QA_Data.txt
#SBATCH --nodes=4
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile.txt llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_Data_+_150k_QA_Data.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-13b-finetune-codellm-LLaVA-data-+-150k-QA-data \
    --num_train_epochs 1 \
