...
#SBATCH --output=junbo-complex+llava.txt
#SBATCH --nodes=2
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile.txt llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/llava_final_v1_5_junbo_complex_+_llava.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-13b-junbo-complex-+llava \
    --num_train_epochs 1 \
