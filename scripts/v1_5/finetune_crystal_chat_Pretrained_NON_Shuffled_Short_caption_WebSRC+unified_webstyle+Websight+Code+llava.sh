...
#SBATCH --output=finetune_Pretrained_with_NON_Shuffled_short_caption______+_______crystal_chat_tokenizer_correct_Websight_websrc_code_QA_llava.txt
#SBATCH --nodes=4
#SBATCH --nodelist=gpumid-06,gpumid-07,gpumid-21,gpumid-22
#SBATCH --mem=200G
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile_new.txt llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/fork_LLaVA/checkpoints/llava-v1.5-7b-crystal_chat-Non_shuffled_short-caption/mm_projector.bin \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-finetune-Pretrained-with-NON_SHUFFLED_short-caption__________+_______crystal_chat-tokenizer-correct_Websight_websrc_code_QA_llava \
    --num_train_epochs 1 \
