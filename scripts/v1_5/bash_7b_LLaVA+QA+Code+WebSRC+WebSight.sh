...
#SBATCH --output=7b-v1.5-7b-WebSRC+WebSight+Code+LLaVA-data-+-150k-QA-data.txt
#SBATCH --nodes=4
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile.txt llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-WebSRC+Unified+WebSight+Code+LLaVA-data_+_150k_QA_data \
    --num_train_epochs 1 \
