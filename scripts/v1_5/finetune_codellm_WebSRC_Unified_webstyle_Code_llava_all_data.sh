...
#SBATCH --output=finetune_codellm_llava_WebSRC_unified_style_code_data_llava_all.txt
#SBATCH --nodes=4
#SBATCH --nodelist=gpumid-27,gpumid-28,gpumid-29,gpumid-30
#SBATCH --mem=200G
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile.txt llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_final_v1_5_WebSRC_+_Unified_web_style_Junbo10k_pix2code_Junbo50k_QA_150k_+_LLAVA_Full.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-13b-finetune-codellm-WebSRC-code-data-unified-web-style-llava-all-data---final \
    --num_train_epochs 1 \
