...
#SBATCH --output=2_epoch_finetune_codellm_llava_only_code.txt
#SBATCH --nodes=4
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile.txt llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-13b-2-epochs-finetune-codellm-only-code-data-unified-web-style \
    --num_train_epochs 2 \
