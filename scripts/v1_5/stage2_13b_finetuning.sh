...
#SBATCH --output=STAGE_2_Long_Caption_no_mimic_shuffled_stage_1_shuffled_short_caption.txt
#SBATCH --nodes=4
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile_new.txt llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/fork_LLaVA/checkpoints/STAGE_2_Long_Caption_no_mimic_shuffled_stage_1_shuffled_short_caption \
    --num_train_epochs 1 \
