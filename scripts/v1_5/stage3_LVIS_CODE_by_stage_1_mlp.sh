#!/bin/bash
#SBATCH --job-name=stage3_LVIS_CODE_by_stage_1_mlp # Job name
#SBATCH --output=stage3_LVIS_CODE_by_stage_1_mlp.txt
#SBATCH --nodes=4
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile_new.txt llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path /lustre/scratch/shared-folders/vision-project/Backup/llava_data/lvis_code.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-stage3_LVIS_CODE_by_stage_1_mlp \
    --num_train_epochs 1 \
