...
#SBATCH --output=7b_llava_sanity_150k.txt
#SBATCH --nodes=4
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile.txt llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/QA_Dataset_GPT4_new.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-sanity_150k_rusiru \
    --num_train_epochs 1 \
