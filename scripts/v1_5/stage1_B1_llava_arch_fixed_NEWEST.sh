#!/bin/bash
#SBATCH --job-name=stage1_B1_llava_arch_fixed_NEWEST # Job name
#SBATCH --output=stage1_B1_llava_arch_fixed_NEWEST.txt
#SBATCH --nodes=4
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile_new.txt llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-stage1_B1_llava_arch_fixed_NEWEST \
    --num_train_epochs 1 \
