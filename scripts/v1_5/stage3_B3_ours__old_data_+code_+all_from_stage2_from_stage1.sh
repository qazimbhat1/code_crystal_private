...
#SBATCH --output=Stage3__ours_old_data_code_all_from_stage2_from_stage1_crystal_chat.txt
#SBATCH --nodes=4
...
deepspeed --hostfile /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/LLaVA/playground/data/llava_finetune_data/hostfile_3.txt llava/train/train_mem.py \
    ...
    --model_name_or_path /lustre/scratch/shared-folders/vision-project/Code/qazim.bhat/fork_LLaVA/checkpoints/STAGE_2_ours_fom_stage1_crystal_chat \
    --version v1 \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-Stage3__ours_old_data_code_all_from_stage2_from_stage1_crystal_chat \
    --num_train_epochs 1 \
